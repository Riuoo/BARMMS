    ...
    <nav class="bg-green-600 text-white fixed w-full top-0 z-50 shadow-lg border-b border-green-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href="{{ route('landing') }}" class="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                    ...
                    <h1 class="text-xl font-bold text-white">Lower Malinao System</h1>
                </a>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="/" class="hover:text-green-200 px-3 py-2 rounded-md text-sm font-medium transition duration-300">Home</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-green-600 border-t border-green-700">
                <a href="/" class="block hover:bg-green-700 text-white px-3 py-2 rounded-md text-base font-medium">Home</a>
                <a href="/accomplishments" class="block bg-green-700 text-white px-3 py-2 rounded-md text-base font-medium">Accomplishments</a>
                <a href="/#contact" class="block hover:bg-green-700 text-white px-3 py-2 rounded-md text-base font-medium">Contact</a>
                <a href="{{ route('admin.contact') }}" class="block bg-green-700 hover:bg-green-800 text-white px-3 py-2 rounded-md text-base font-medium">Request Account</a>
            </div>
        </div>
    </nav>
