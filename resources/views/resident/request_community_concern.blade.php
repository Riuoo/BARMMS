...
@section('title', 'Submit Community Concern')

@section('content')
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
    <!-- Header Skeleton -->
    <div id="rcHeaderSkeleton" class="animate-pulse mb-8">
        <div class="h-8 w-96 bg-gray-200 rounded mb-2"></div>
        <div class="h-4 w-[28rem] bg-gray-100 rounded"></div>
    </div>

    <!-- Form Skeleton -->
    <div id="rcFormSkeleton" class="animate-pulse bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="space-y-6">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Submit Community Concern</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('resident.request_community_concern') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Upload photos, videos, or documents to support your concern</p>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6">
                <div class="text-sm text-gray-500">
                    ...
                    Your concern will be reviewed by barangay officials
                </div>
                <div class="flex space-x-3">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-blue-700">
                    <ul class="list-disc pl-5 space-y-1">
                        ...
                        <li>You can track the status of your concern in "My Requests"</li>
                    </ul>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Skeleton transition
    setTimeout(() => {
        const hs = document.getElementById('rcHeaderSkeleton');
        const fs = document.getElementById('rcFormSkeleton');
