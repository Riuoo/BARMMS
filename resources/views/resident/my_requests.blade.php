...
<div class="max-w-7xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="residentReqHeaderSkeleton" class="animate-pulse mb-3">
    ...
    <!-- Stats Skeleton -->
    <div id="residentReqStatsSkeleton" class="animate-pulse grid grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-4 mb-3">
        @for($i = 0; $i < 5; $i++)
    ...
    <!-- Filters Skeleton -->
    <div id="residentReqFiltersSkeleton" class="animate-pulse mb-3 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
    ...
    <div id="residentReqTableSkeleton" class="animate-pulse hidden md:block bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div id="residentReqMobileSkeleton" class="animate-pulse md:hidden space-y-4">
        @for($i = 0; $i < 3; $i++)
    ...
    <!-- Pagination Skeleton -->
    <div id="residentReqPaginationSkeleton" class="animate-pulse mt-6">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        setTimeout(() => {
            const skeletons = [
                'residentReqHeaderSkeleton','residentReqStatsSkeleton','residentReqFiltersSkeleton',
                'residentReqTableSkeleton','residentReqMobileSkeleton','residentReqPaginationSkeleton'
            ];
