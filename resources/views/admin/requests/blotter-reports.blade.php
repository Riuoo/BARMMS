        ...
        <div class="mb-2">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0 flex space-x-2">
                    ...
                    @endif
                    @if($canPerformTransactions)
                    <a href="{{ route('admin.blotter-templates.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                        <i class="fas fa-file-alt mr-2"></i>
                        Manage Templates
                    </a>
                    @endif
                    <a href="{{ route('clustering.blotter.analysis') }}" class="inline-flex items-center px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-200">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" name="search" id="blotterSearchInput" placeholder="Search blotter reports..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500" value="{{ request('search') }}">
                    </div>
                </div>
                <!-- Status Filter -->
                <div class="sm:w-48">
                            ...
                            <tr class="blotter-item hover:bg-gray-50 transition duration-150" data-status="{{ $request->status }}" data-summon="{{ optional($request->summon_date)->format('Y-m-d\TH:i') }}" data-approved="{{ optional($request->approved_at)->format('Y-m-d\TH:i') }}">
                                <td class="px-4 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">{{ $request->complainant_name ?? 'N/A' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-4">
                                    ...
                                    <div class="text-sm text-gray-900 max-w-xs">
                                        ...
                                        @if(strlen($request->description) > 40)
                                            <button 
                                                ...
                                                data-user-name="{{ $request->complainant_name ?? 'N/A' }}">
                                                View Full
                                            </button>
                                        @endif
                                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-2xl border border-gray-100">
                    <div class="flex items-start justify-between px-6 py-5 border-b border-gray-100">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-sm uppercase tracking-wide text-gray-500">Incident Description</p>
