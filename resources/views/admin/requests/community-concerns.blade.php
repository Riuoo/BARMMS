...
<div class="max-w-7xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="concernsHeaderSkeleton" class="mb-3 animate-pulse">
    ...
    <!-- Filters Skeleton -->
    <div id="concernsFiltersSkeleton" class="mb-3 bg-white rounded-lg shadow-sm border border-gray-200 p-4 animate-pulse">
    ...
    <!-- Stats Skeleton -->
    <div id="concernsStatsSkeleton" class="grid grid-cols-2 lg:grid-cols-6 gap-3 lg:gap-4 mb-3 animate-pulse">
        @for ($i = 0; $i < 6; $i++)
    ...
    <div id="concernsTableSkeleton" class="hidden md:block bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-pulse mb-6">
    ...
    <div id="concernsMobileSkeleton" class="md:hidden space-y-4 animate-pulse mb-6">
        @for ($i = 0; $i < 4; $i++)
    ...
    <!-- Pagination Skeleton -->
    <div id="concernsPaginationSkeleton" class="mt-6 animate-pulse">
