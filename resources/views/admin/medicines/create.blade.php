...
<div class="max-w-4xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="medicineCreateHeaderSkeleton" class="animate-pulse mb-3">
        <div class="h-8 w-80 bg-gray-200 rounded mb-2"></div>
        <div class="h-4 w-96 bg-gray-100 rounded"></div>
    </div>

    <!-- Form Skeleton -->
    <div id="medicineCreateFormSkeleton" class="animate-pulse bg-white p-6 rounded-lg shadow-sm border border-gray-200 space-y-6">
