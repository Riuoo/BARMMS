...
<div class="max-w-7xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="medicineReportHeaderSkeleton" class="animate-pulse mb-3">
        <div class="h-8 w-80 bg-gray-200 rounded mb-2"></div>
        <div class="h-4 w-96 bg-gray-100 rounded"></div>
    </div>

    <!-- Filters Skeleton -->
    <div id="medicineReportFiltersSkeleton" class="animate-pulse mb-3 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
    ...
    <div id="medicineReportCharts1Skeleton" class="animate-pulse grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
    ...
    <div id="medicineReportCharts2Skeleton" class="animate-pulse grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        @for($i = 0; $i < 3; $i++)
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="h-6 w-56 bg-gray-200 rounded mb-2"></div>
            <div class="h-4 w-24 bg-gray-100 rounded mb-4"></div>
    ...
    <div id="medicineReportCategorySkeleton" class="animate-pulse grid grid-cols-1 gap-4 mb-6">
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="h-6 w-56 bg-gray-200 rounded mb-2"></div>
            <div class="h-56 w-full bg-gray-200 rounded"></div>
        </div>
    ...
    <div id="medicineReportSummarySkeleton" class="animate-pulse bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        const skeletonElements = [
            'medicineReportHeaderSkeleton', 'medicineReportFiltersSkeleton', 'medicineReportCharts1Skeleton',
            'medicineReportCharts2Skeleton', 'medicineReportCategorySkeleton', 'medicineReportSummarySkeleton'
        ];
