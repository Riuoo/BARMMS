...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('admin.patient-records.show', $patientRecord->id) }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.patient-records.update', $patientRecord->id) }}" method="POST">
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('admin.patient-records.show', $patientRecord->id) }}" class="bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700">
                    Cancel
                </a>
...
<script>
// Remove document.getElementById('height_cm').addEventListener('input', calculateBMI);
// Remove document.getElementById('weight_kg').addEventListener('input', calculateBMI);
// Remove the calculateBMI() function.
// Add a note near the BMI field: 'BMI will be calculated after saving.'
</script>
@endsection 