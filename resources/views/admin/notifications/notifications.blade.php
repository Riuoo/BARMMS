...
<div class="max-w-7xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="adminNotifHeaderSkeleton" class="animate-pulse mb-3">
    ...
    <!-- Filters Skeleton -->
    <div id="adminNotifFiltersSkeleton" class="animate-pulse mb-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
    ...
    <!-- Table Skeleton -->
    <div id="adminNotifTableSkeleton" class="animate-pulse bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        ['adminNotifHeaderSkeleton','adminNotifFiltersSkeleton','adminNotifTableSkeleton'].forEach(id => {
