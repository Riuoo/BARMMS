...
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
    <!-- Header Skeleton -->
    <div id="createChildHeaderSkeleton" class="animate-pulse mb-8">
    ...
    <!-- Form Skeleton -->
    <div id="createChildFormSkeleton" class="animate-pulse bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="space-y-6">
