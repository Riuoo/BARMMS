...
<div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="relative">
                <input type="text" id="blotterSearchInput" placeholder="Search reports..." class="w-full sm:w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900" id="total-count">{{ $blotterRequests->count() }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900" id="pending-count">{{ $blotterRequests->where('status', 'pending')->count() }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900" id="approved-count">{{ $blotterRequests->where('status', 'approved')->count() }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900" id="completed-count">{{ $blotterRequests->where('status', 'completed')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr class="blotter-item hover:bg-gray-50 transition duration-150" data-status="{{ $request->status }}">
                            ...
                            <td class="px-6 py-4">
                                @if($request->media_files)
                                    <div class="text-sm text-gray-900">{{ count($request->media_files) }} files</div>
                                    <div class="text-sm text-gray-500">
...
<!-- Modals -->
@include('admin.partials.blotter-modals')

<script>
document.addEventListener('DOMContentLoaded', function() {
    // Filter functionality
    const filterBtns = document.querySelectorAll('.filter-btn');
    const blotterItems = document.querySelectorAll('.blotter-item');
    const blotterCards = document.querySelectorAll('.blotter-card');
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Filter reports
            const allItems = [...blotterItems, ...blotterCards];
...
// Modal functions are defined in the partial file (admin.partials.blotter-modals)
</script>
@endsection