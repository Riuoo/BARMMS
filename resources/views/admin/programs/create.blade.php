...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        ...
        <p class="text-gray-600">
            Define a new program with eligibility criteria
        </p>
    </div>

    <form method="POST" action="{{ route('admin.programs.manage.store') }}" id="programForm">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input type="number" id="priority" name="priority" value="{{ old('priority', 0) }}" min="0" max="10"
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <input type="hidden" name="criteria" id="criteria-json" value="{{ old('criteria', '') }}">
                ...
                @foreach($puroks as $purok)
                    <label class="flex items-center">
                        <input type="checkbox" name="target_puroks[]" value="{{ $purok['token'] }}"
                               {{ in_array($purok['token'], old('target_puroks', [])) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
...
<script>
    // Initialize criteria builder on page load
