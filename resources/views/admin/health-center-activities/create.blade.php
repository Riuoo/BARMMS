...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Create Health Center Activity</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form action="{{ route('admin.health-center-activities.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="4" 
                              class="w-full border border-gray-300 rounded px-3 py-2" 
                              placeholder="Detailed description of the activity..." required>{{ old('description') }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="objectives" id="objectives" rows="3" 
                              class="w-full border border-gray-300 rounded px-3 py-2" 
                              placeholder="Goals and objectives of the activity...">{{ old('objectives') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <textarea name="required_resources" id="required_resources" rows="3" 
                                  class="w-full border border-gray-300 rounded px-3 py-2" 
                                  placeholder="Equipment, supplies, materials needed...">{{ old('required_resources') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="staff_involved" id="staff_involved" rows="3" 
                                  class="w-full border border-gray-300 rounded px-3 py-2" 
                                  placeholder="Healthcare staff, volunteers, etc...">{{ old('staff_involved') }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('admin.health-center-activities.index') }}" 
                       class="bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700">
                        Cancel
                    </a>
                    <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">
                        <i class="fas fa-save mr-2"></i>Create Health Center Activity
                    </button>
                </div>
            </form>
        </div>
