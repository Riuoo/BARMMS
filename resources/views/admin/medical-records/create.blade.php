...
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
    <!-- Header Skeleton -->
    <div id="createMedicalHeaderSkeleton" class="animate-pulse mb-8">
    ...
    <!-- Form Skeleton -->
    <div id="createMedicalFormSkeleton" class="animate-pulse bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="space-y-6">
            ...
            <!-- Follow-up & Health Worker Section -->
            <div class="border-b border-gray-200 pb-6">
                <div class="flex items-center mb-4">
                    <div class="w-6 h-6 bg-gray-200 rounded mr-3"></div>
