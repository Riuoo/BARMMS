...
<div class="max-w-7xl mx-auto pt-2">
    <!-- Header Skeleton -->
    <div id="documentAnalysisHeaderSkeleton" class="mb-6 animate-pulse">
    ...
    <!-- Stats Skeleton -->
    <div id="documentAnalysisStatsSkeleton" class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-3 animate-pulse">
        @for ($i = 0; $i < 4; $i++)
    ...
    <!-- Charts Skeleton -->
    <div id="documentAnalysisChartsSkeleton" class="space-y-6 mb-3 animate-pulse">
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        const headerSkeleton = document.getElementById('documentAnalysisHeaderSkeleton');
        const statsSkeleton = document.getElementById('documentAnalysisStatsSkeleton');
        const chartsSkeleton = document.getElementById('documentAnalysisChartsSkeleton');
