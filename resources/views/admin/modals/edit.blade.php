            ...
            <form action="{{ route('admin.patient-records.update', $patientRecord->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" value="{{ $patientRecord->resident->name }}" 
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $patientRecord->patient_number }}" 
                                   class="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="risk_level" id="risk_level" class="w-full border border-gray-300 rounded px-3 py-2" required>
                            ...
                            <option value="Critical" {{ old('risk_level', $patientRecord->risk_level) == 'Critical' ? 'selected' : '' }}>Critical</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="height_cm" id="height_cm" 
                               value="{{ old('height_cm', $patientRecord->height_cm) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="weight_kg" id="weight_kg" 
                               value="{{ old('weight_kg', $patientRecord->weight_kg) }}" 
                               class="w-full border border-gray-300 rounded px-3 py-2" 
                    ...
                    <div>
                        ...
                        <select name="blood_pressure_status" id="blood_pressure_status" class="w-full border border-gray-300 rounded px-3 py-2">
                            ...
                            <option value="Pre-hypertension" {{ old('blood_pressure_status', $patientRecord->blood_pressure_status) == 'Pre-hypertension' ? 'selected' : '' }}>Pre-hypertension</option>
                            <option value="Hypertension" {{ old('blood_pressure_status', $patientRecord->blood_pressure_status) == 'Hypertension' ? 'selected' : '' }}>Hypertension</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <textarea name="allergies" id="allergies" rows="3" 
                                  class="w-full border border-gray-300 rounded px-3 py-2" 
                                  placeholder="List any known allergies...">{{ old('allergies', $patientRecord->allergies) }}</textarea>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <textarea name="medical_history" id="medical_history" rows="4" 
                                  class="w-full border border-gray-300 rounded px-3 py-2" 
                                  placeholder="Past medical conditions, surgeries, etc...">{{ old('medical_history', $patientRecord->medical_history) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="family_medical_history" id="family_medical_history" rows="4" 
                                  class="w-full border border-gray-300 rounded px-3 py-2" 
                                  placeholder="Family history of diseases...">{{ old('family_medical_history', $patientRecord->family_medical_history) }}</textarea>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="lifestyle_factors" id="lifestyle_factors" rows="3" 
                              class="w-full border border-gray-300 rounded px-3 py-2" 
                              placeholder="Smoking, alcohol consumption, exercise habits, etc...">{{ old('lifestyle_factors', $patientRecord->lifestyle_factors) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="emergency_contact_name" id="emergency_contact_name" 
                               value="{{ old('emergency_contact_name', $patientRecord->emergency_contact_name) }}" 
                               class="w-full border border-gray-300 rounded px-3 py-2" 
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_number" id="emergency_contact_number" 
                               value="{{ old('emergency_contact_number', $patientRecord->emergency_contact_number) }}" 
                               class="w-full border border-gray-300 rounded px-3 py-2" 
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_relationship" id="emergency_contact_relationship" 
                               value="{{ old('emergency_contact_relationship', $patientRecord->emergency_contact_relationship) }}" 
                               class="w-full border border-gray-300 rounded px-3 py-2" 
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" id="notes" rows="4" 
                              class="w-full border border-gray-300 rounded px-3 py-2" 
                              placeholder="Any additional notes or observations...">{{ old('notes', $patientRecord->notes) }}</textarea>
                </div>
