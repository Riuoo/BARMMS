...
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
    <!-- Header Skeleton -->
    <div id="adminProfileHeaderSkeleton" class="animate-pulse mb-8">
    ...
    <!-- Cards Skeleton -->
    <div id="adminProfileCardsSkeleton" class="animate-pulse">
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        ['adminProfileHeaderSkeleton','adminProfileCardsSkeleton'].forEach(id => {
