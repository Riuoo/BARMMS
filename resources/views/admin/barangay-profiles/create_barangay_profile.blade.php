    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-8">
        ...
        <form action="{{ route('admin.barangay-profiles.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-between mt-8">
                <a href="{{ route('admin.barangay-profiles') }}" class="px-5 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition">Cancel</a>
                <button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-md font-semibold hover:bg-green-700 transition">Add Profile</button>
            </div>
        </form>
    </div>
@endsection