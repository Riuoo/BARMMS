...
class ResidentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Residents::create([
            ...
            'password' => bcrypt('password123'),
            'role' => 'resident',
            'address' => 'Purok 11, Lower Malinao, Padada City',
            'gender' => 'Female',
        ...
        Residents::create([
            ...
            'password' => bcrypt('password123'),
            'role' => 'resident',
            'address' => 'Purok 12, Lower Malinao, Padada City',
            'gender' => 'Male',
        ...
        Residents::create([
            ...
            'password' => bcrypt('password123'),
            'role' => 'resident',
            'address' => 'Purok 13, Lower Malinao, Padada City',
            'gender' => 'Female',
        ...
        Residents::create([
            ...
            'password' => bcrypt('password123'),
            'role' => 'resident',
            'address' => 'Purok 14, Lower Malinao, Padada City',
            'gender' => 'Male',
        ...
        Residents::create([
            ...
            'password' => bcrypt('password123'),
            'role' => 'resident',
            'address' => 'Purok 15, Lower Malinao, Padada City',
            'gender' => 'Female',
